...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { name: @employer.name, short_name: @employer.short_name, type: @employer.type } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { name: @employer.name, short_name: @employer.short_name, type: @employer.type } }
