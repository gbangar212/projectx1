...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { candidate: @support.candidate, interviewer: @support.interviewer, message: @support.message, request: @support.request, type: @support.type } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { candidate: @support.candidate, interviewer: @support.interviewer, message: @support.message, request: @support.request, type: @support.type } }
