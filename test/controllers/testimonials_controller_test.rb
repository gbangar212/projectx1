...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { from_id: @testimonial.from_id, text: @testimonial.text, to_id: @testimonial.to_id } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { from_id: @testimonial.from_id, text: @testimonial.text, to_id: @testimonial.to_id } }
